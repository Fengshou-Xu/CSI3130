					 ...
					 Plan *inner_plan)
{
	...
	Hash	   *inner_hash_plan; //CSI3130 new added, the other hash plan
    Hash       *outer_hash_plan; //CSI3130 two hash plans(inner and outer)
    ...
    outer_hash_plan = make_hash(outer_plan); //CSI3130 new added new hash plan for outer
	...
	join_plan = make_hashjoin(tlist,
							  ...
							  (Plan *) outer_hash_plan, //CSI3130 change the old hash plan 
							  (Plan *) inner_hash_plan, //CSI3130 into two hash plans (inner and outer)
